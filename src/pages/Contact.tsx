...
import { Mail, Phone, MapPin, Clock, Send, MessageSquare, Globe, Calendar, Star, Award, Shield, Zap, ShoppingCart } from 'lucide-react';
import InquiryForm from '../components/InquiryForm';
import OrderForm from '../components/OrderForm';

const Contact = () => {
  const [activeTab, setActiveTab] = useState<'inquiry' | 'order'>('inquiry');
  const tabs = [
    {
      id: 'inquiry' as const,
      title: 'General Inquiry',
      icon: MessageSquare,
      description: 'Ask questions about our heritage collection'
    },
    {
      id: 'order' as const,
      title: 'Place Order',
      icon: ShoppingCart,
      description: 'Order items from our curated selection'
    }
  ];
      ...
      <section className="section-padding bg-forest-light/5">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              >
                {/* Tab Navigation */}
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl luxury-shadow p-2">
                      ...
                      return (
                        <motion.button
                          ...
                          className={`p-4 rounded-xl transition-all duration-300 text-left ${
                            activeTab === tab.id
                              ? 'bg-gradient-to-r from-amber-600 to-orange-600 text-white luxury-shadow'
                ...
                >
                  {activeTab === 'inquiry' ? <InquiryForm /> : <OrderForm />}
                </motion.div>
               </motion.div>
             </div>
           </div>
       ...
       <section className="section-padding bg-white">
         <div className="container-custom">
           ...
           >
             <h2 className="text-3xl md:text-4xl font-heading font-bold text-forest-deep mb-4">
               Visit Our Offices
             </h2>
             <div className="w-20 h-1 bg-forest-mid rounded-full mx-auto mb-6"></div>
             <p className="text-xl text-gray-600 max-w-3xl mx-auto">
               Connect with our global team of sourcing experts at any of our strategic locations worldwide.
             </p>
           </motion.div>
